...
**2026-09-12·角色卡法术信息去重**:用户反馈"每一页都有法术选择的部分"——上轮加「法术总览」后,职业特性区块仍保留旧的施法属性/法术位/已选戏法/已选法术行,打印分页后法术内容散布多处。修:职业区块只留一行「施法信息与法术清单: 见下方『法术总览』」,施法汇总唯一化(总览 1 次+法术详情 1 次);@media print 补隐藏 .sheet 内按钮(复制代码按钮不上打印件)。
